...
class _MapPageState extends State<MapPage> {
        ...
        children: [
          ...
          ElevatedButton(
            style: ButtonStyle(
              ...
              minimumSize: MaterialStateProperty.all<Size>(Size(200, 50)), // Set the height to 50
            ),
            onPressed: () {
  ...
  void generatePolyLineFromPoints(List<LatLng> polylineCoordinates) async {
    ...
    // Center the camera on the polyline
    _cameraToPosition(polylineCoordinates.first);
  }

  List<LatLng> _getLocationsFromPlacesList(
