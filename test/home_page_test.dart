...
void main() {
  group('HomePage Widget Tests', () {
    ...
    testWidgets('HomePage UI Test', (WidgetTester tester) async {
      ...
      expect(find.byKey(ValueKey('Starting Point')), findsOneWidget);
      expect(find.byKey(ValueKey('Ending Point')), findsOneWidget);
    ...
    testWidgets('Test Search Place Functionality', (WidgetTester tester) async {
      ...
      final startingField = find.byKey(ValueKey('Starting Point'));
      final endingField = find.byKey(ValueKey('Ending Point'));
